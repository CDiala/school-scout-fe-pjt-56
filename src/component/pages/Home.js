  ...
  return (
    <div>
      ...
      <section className="landing-hero">
        <div className="schpg-container landing-cont">
          <div className="block landing-block">
            <h1 className="lnd-hero__heading">
              Let’s help you make the <br /> best educational choices
            </h1>
            <p className="lnd-para">
              You don’t have to travel distances or search a lot of sites.
              School scouting made easy.
            </p>
        ...
        <div className="options-container">
          <div className="options-top-section">
            <div className="options-top-text">
              <h2 className="textsA">Find the Best</h2>
              <p className="textsB">
                Begin your research here now, and make the best decision ever
              </p>
            </div>
          </div>
      ...
      <section className="landing-und-cont">
        <div className="undecided-container landing-padding">
          <div className="left">
            <div className="ah-txt-cont">
              <h2 className="texts1">Undecided about what course to study</h2>
              <p className="texts2">
                let's help you discover what's best for you in 3 easy steps
              </p>
            </div>
            <div className="numbers">
              <div className="ah-num-cont">
            ...
            <Link
              to={process.env.PUBLIC_URL + "/career-advisory/cap-2"}
              className="hm-btn undecided"
            >
              Get Started
            </Link>
          </div>
      ...
      <section className="landing-testimonial-section landing-padding">
        <div className="testimonials-container">
          <div>
            <h2 className="textsTH">Testimonials</h2>
            <p className="textsTP">
              What people that have used this website have to say about us.
            </p>
          </div>
          ...
          <div className="btn-cont">
            <button className="hm-btn-see">See More</button>
          </div>
        </div>
      </section>
        ...
        <div className="articles-container">
          <div>
            <div>
              ...
              <p className="texts">
                i bet you would want to read these articles, selected for you
              </p>
            </div>
            <div></div>
          </div>
